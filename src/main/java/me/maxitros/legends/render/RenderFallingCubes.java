...
public class RenderFallingCubes extends Render<EntityFallingCube>
{
    public RenderFallingCubes(RenderManager renderManagerIn)
    {
        super(renderManagerIn);
        this.shadowSize = 0.5F;
    }

    public void doRender(EntityFallingCube entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    protected ResourceLocation getEntityTexture(EntityFallingCube entity)
    {
